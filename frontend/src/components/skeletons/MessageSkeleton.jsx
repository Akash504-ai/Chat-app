const MessageSkeleton = () => {
  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto px-2 sm:px-4 py-3 space-y-3 sm:space-y-4 w-full">
      {skeletonMessages.map((_, idx) => {
        ...
        return (
          <div
            key={idx}
            className={`flex items-end gap-2 sm:gap-3 w-full min-w-0 ${
